const translations = {
  ...
  function updateLanguage(lang) {
    ...
    if (items[0]) items[0].querySelector("h3").innerText = translations[lang].familyRooms;
    if (items[1]) items[1].querySelector("h3").innerText = translations[lang].singleRooms;
